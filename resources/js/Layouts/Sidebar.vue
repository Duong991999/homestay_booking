<template>
    <Authenticated-layout>
        <a-layout style="min-height: 100vh">
            <a-layout-sider
                class="sider-custom"
                style="overflow: auto; height: 100vh; position: fixed; z-index: 1000"
            >
                <!-- <div class="logo" /> -->
                <a-menu v-model:selectedKeys="selectedKeys" mode="inline">
                    ...
                    <a-menu-item v-if="currentRole !== 'ADMIN'" key="apartments">
                        ...
                        <a :href="route('apartments.show')" class="menu-link">Apartment Detail</a>
                    </a-menu-item>
                    ...
                    <a-menu-item v-if="currentRole === 'ADMIN'" key="registrations">
                        ...
                        <a :href="route('registrations.index')" class="menu-link">Registrations </a>
                    </a-menu-item>
                    <a-menu-item v-if="currentRole === 'ADMIN'" key="apartments">
                        <home-outlined />
                        <a :href="route('apartments.index')" class="menu-link">Apartments </a>
                    </a-menu-item>
                    <a-menu-item v-if="currentRole === 'OWNER'" key="tenant-accounts">
                        <user-outlined />
                        <a :href="route('tenant-accounts.index')" class="menu-link">Tenants</a>
                    </a-menu-item>
                    <a-menu-item v-if="currentRole === 'OWNER'" key="facilities">
                        <build-outlined />
                        <a :href="route('facilities.index')" class="menu-link">Facilities</a>
                    </a-menu-item>
                    <a-menu-item v-if="currentRole !== 'ADMIN'" key="invoices">
                        <dollar-circle-outlined />
                        <a :href="route('invoices.index')" class="menu-link">Invoices</a>
                    </a-menu-item>
                    <a-menu-item v-if="currentRole !== 'ADMIN'" key="payments">
                        <file-done-outlined />
                        <a :href="route('payments.index')" class="menu-link">Payments</a>
                    </a-menu-item>
                    ...
                    <a-menu-item v-if="currentRole === 'OWNER'" key="history">
                        <history-outlined />
                        <a :href="route('history.index')" class="menu-link">History</a>
                    </a-menu-item>
                </a-menu>
            </a-layout-sider>
        </a-layout>
