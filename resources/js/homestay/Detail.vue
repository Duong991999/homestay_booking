				...
				<div class="card bg-transparent w-100 border-0" style="padding-right: 30px">
					...
					<div class="card-body pt-4 p-0">
						...
						<a class="p-0 mb-4 mt-2 btn-more d-flex align-items-center collapsed" data-bs-toggle="collapse"
							...
							See <span class="see-more ms-1">more</span><span class="see-less ms-1">less</span></a>
									...
									<div>
												...
												<div class="" role="group">
													...
													<div class="">
														<input id="first-name" class="form-control form-control-lg"
															...
															:class="[{ 'is-invalid': errorFor('guest_name') }]"
										...
										<div class="row">
											<div class="col-md-6">
												...
												<div class="">
													<input
														:class="[{ 'is-invalid': errorFor('checkin_date') }, { 'form-control form-control-lg': 1 }]"
											...
											<div class="col-md-6">
												...
												<div class="">
													<input
														:class="[{ 'is-invalid': errorFor('checkout_date') }, { 'form-control form-control-lg': 1 }]"
					...
					<div>
						<div class="card w-100" style="margin-top: 100px">
							...
							<div class="mt-2 mb-2">
								<div class="row justify-content-around">
									...
									<div class="col-md-5 mt-4">
										<div class="form-border-bottom d-flex align-items-center"
											...
											<div class="w-100">
												<div class="dropdown me-2">
													<input type="text"
														...
														aria-expanded="true" :value="displayOccupants"
														@click="toggleDropdown" />
													<span class="input__label">Khách hàng</span>
													<ul class="dropdown-menu guest-selector-dropdown w-100"
														...
														<li class="row d-flex justify-content-between">
															...
															<div class="row align-items-center"
																style="margin-right: 10px">
																<button class="btn btn-md btn-link" @click="
																	decreaseCount('children')
																	">
																	<svg width="1em" height="1em" viewBox="0 0 16 16"
																		fill="currentColor" role="img" focusable="false"
																		class="fs-5 fa-fw">
							...
							<div class="d-flex justify-content-center">
								<button class="btn border-0 m-2" @click="check" :disabled="loading" style="
						...
						<div class="card bg-transparent border-0" style="margin-top: 50px">
							...
							<div class="card-body pt-4 p-0">
								<div class="card p-3" v-for="(room, index) in rooms" :key="index" style="width: 400px">
									<div class="row g-4">
											...
											<div class="card-body d-flex flex-column h-100" style="
												...
												<div class="row align-items-center" style="margin-right: 10px">
													<button class="btn btn-md btn-link">
														<svg width="1em" height="1em" viewBox="0 0 16 16"
															fill="currentColor" role="img" focusable="false"
															class="fs-5 fa-fw" @click="decreaseCount('count', index)">
															<path
																d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16">
															</path>
															<path
													...
													<button class="btn btn-md btn-link">
														<svg width="1em" height="1em" viewBox="0 0 16 16"
															fill="currentColor" role="img" focusable="false"
															class="fs-5 fa-fw" @click="increaseCount('count', index)">
															<path
																d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16">
															</path>
...
export default {
	...
	methods: {
		...
		async loadData() {
			...
			this.files[1].style = `background-image: url(${this?.files[1]?.file_path ?? 'assets/image/slide_home_screens/_1.jpg'});background-position: left center;background-size: cover;height: 240px;`
			this.files[2].style = `background-image: url(${this?.files[2]?.file_path ?? 'assets/image/slide_home_screens/_1.jpg'});background-position: left center;background-size: cover;height: 150px;`
			this.files[3].style = `background-image: url(${this?.files[3]?.file_path ?? 'assets/image/slide_home_screens/_1.jpg'});background-position: left center;background-size: cover;height: 150px;`
			this.loading = false
		},
		toggleDropdown() {
