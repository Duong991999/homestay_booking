<template>
    <div class="container" style="margin-top: 80px">
        ...
        <div class="mt-4">
            <label
                class="btn btn-primary btn-primary-check mb-0 collapsed p-2"
                for="btn-check-soft"
                    ...
                    <form class="row g-4 px-4">
                        <div class="col-md-5 col-lg-6">
                            <div class="form-control-borderless">
                                <label class="form-label font-weight-bold">Tên Homestay </label
                                ><input
                                    type="text"
                        ...
                        <div class="col-md-5 col-lg-6" style="padding-top: 30px">
                            <div class="form-control-borderless">
                                ...
                                <star-rating :star-size="35" :show-rating="false"></star-rating>
                            </div>
                        </div>
                        ...
                        <div class="col-12 d-flex justify-content-end">
                            <button
                                class="btn btn-md btn-link p-0 mb-0 text-decoration-none"
                                type="button"
                                style="margin-right: 30px"
                            >
                                Xóa hết</button
                            ><button
                                class="btn btn-dark mb-0 ms-3 text-decoration-none"
                                type="button"
                            >
                                Tìm kiếm
                            </button>
...
export default {
    ...
    data() {
        return {
            ...
            CategoryOptions: ['Batman', 'Robin', 'Joker'],
            amenities: [
                'Điều hòa ',
                'Dịch vụ phòng',
                'Ăn uống',
...
.slide-fade-vertical-leave-to /* .slide-fade-vertical-leave-active in <2.1.8 */ {
